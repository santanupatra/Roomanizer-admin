                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Table hover bordered striped responsive size="sm">
                                ...
                                <tbody>
                                    {props.room && props.room.roomList.count > 0 ?
                                        props.room.roomList.list.map((val) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td className="text-center">
                                                        ...
                                                        <Button size="sm" className="btn-youtube btn-brand mr-1 mb-1" data-toggle="tooltip" title="Delete" onClick={() => { if (window.confirm('Are you sure you want to delete this room?')) { deleteRoom(val._id) } }}>
